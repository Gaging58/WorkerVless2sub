...
let mytoken= ['123456'];//快速订阅访问入口, 留空则不启动快速订阅
...
let addresses = [
	...
	'acjp2.cloudflarest.link#反代优选2',
	'acsg3.cloudflarest.link#bp优选',
];

// 设置优选地址api接口
let addressesapi = [
	'https://cf-workers-text2kv-2uw.pages.dev/ip.txt?token=123456', //可参考内容格式 自行搭建。
	//'https://cf-workers-text2kv-2uw.pages.dev/ipv6.txt?token=123456', //IPv6优选内容格式 自行搭建。
];
...
let addressesnotlsapi = [
	'https://cf-workers-text2kv-2uw.pages.dev/notls.txt?token=123456', //可参考内容格式 自行搭建。
];

let DLS = 8;//速度下限
let addressescsv = [
	//'https://cf-workers-text2kv-2uw.pages.dev/result.csv?token=123456', //iptest测速结果文件。
];
